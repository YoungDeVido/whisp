...
<svelte:head>
  <title>whisp.so - secure whisping notes</title>
  <meta
    name="description"
    content="open source end-to-end encrypted whisping notes"
  />

  <meta property="og:url" content="https://www.whisp.so/" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="whisp.so - secure whisping notes" />
  <meta
    property="og:description"
    content="open source end-to-end encrypted whisping notes"
  />
  <meta property="og:image" content="https://www.whisp.so/og.png" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="whisp.so" />
  <meta property="twitter:url" content="https://www.whisp.so/" />
  <meta name="twitter:title" content="whisp.so - secure whisping notes" />
  <meta
    name="twitter:description"
    content="open source end-to-end encrypted whisping notes"
  />
  <meta name="twitter:image" content="https://www.whisp.so/og.png" />
</svelte:head>
<main
  ...
  <div class="flex items-center justify-between w-full max-w-5xl my-6 px-10">
    <a href="/" data-sveltekit-reload>
      <h1 class="font-semibold text-white font-clash text-2xl">
        whisp<span class="text-[#BCA4F5]/30">.</span><span
    ...
    <div class="flex items-center gap-6 text-primary font-medium text-sm">
      ...
      <a
        href="https://github.com/bvvst/whispso"
